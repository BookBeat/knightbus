...
## Extensions
Support for Azure Managed Identity authentication in PostgreSQL, for instances hosted in Azure.

| Package                                                                                                             | NuGet                                                                                                                                                                                       |
|---------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [KnightBus.PostgreSql.Extensions.Azure](https://www.nuget.org/packages/KnightBus.PostgreSql.Extensions.Azure/)            | [![KnightBus.PostgreSql.Extensions.Azure](https://img.shields.io/nuget/v/KnightBus.PostgreSql.Extensions.Azure.svg)](https://www.nuget.org/packages/KnightBus.PostgreSql.Extensions.Azure/)                   |
| [KnightBus.PostgreSql.Management.Extensions.Azure](https://www.nuget.org/packages/KnightBus.PostgreSql.Management.Extensions.Azure/) | [![KnightBus.PostgreSql.Management.Extensions.Azure](https://img.shields.io/nuget/v/KnightBus.PostgreSql.Management.Extensions.Azure.svg)](https://www.nuget.org/packages/KnightBus.PostgreSql.Management.Extensions.Azure/)                   |
