...
public static class HostConfigurationExtensions
{
    ...
    public static IServiceCollection AddMiddleware<T>(this IServiceCollection services)
        where T : class, IMessageProcessorMiddleware
    {
    ...
    public static IServiceCollection AddMiddleware(
        ...
        IMessageProcessorMiddleware middleware
    )
    {
    ...
    public static IServiceCollection AddPlugin<T>(this IServiceCollection services, T plugin)
        where T : class, IPlugin
    {
    ...
    public static IServiceCollection UseSingletonLocks(
        this IServiceCollection services,
