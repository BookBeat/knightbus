...
public class SchedulingPlugin : IPlugin
{
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        var scheduleProcessors = dependencyInjection
            .GetOpenGenericRegistrations(typeof(IProcessSchedule<>))
            .ToList();
        ...
        {
            var processorInterfaces =
                ReflectionHelper.GetAllInterfacesImplementingOpenGenericInterface(
                    processor,
            ...
            foreach (var processorInterface in processorInterfaces)
            {
                ...
                var trigger = TriggerBuilder
                    ...
                    .WithCronSchedule(
                        ...
                        builder => builder.InTimeZone(settings.TimeZone)
                    )
                    .WithIdentity(Guid.NewGuid().ToString())
                    .StartNow()
                    .Build();
