...
namespace KnightBus.Microsoft.DependencyInjection
{
    public static class MicrosoftDependencyInjectionExtensions
    {
        ...
        /// </summary>
        public static IServiceCollection RegisterProcessors(this IServiceCollection services, Assembly assembly)
        {
        ...
        public static void RegisterGenericProcessor(this IServiceCollection services, Type implementingType, Type openGenericType)
        {
            ...
            foreach (var @interface in interfaces)
            {
                ...
                services.AddScoped(typeof(IGenericProcessor), provider => provider.GetRequiredService(@interface));
            }
        }
        public static void RegisterGenericProcessor(this IServiceCollection services, Type openGenericType, Assembly assembly)
        {
